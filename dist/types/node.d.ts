import { TypeNames, TypeProperty } from "./types";
...
export declare type NodeInput = TypeNames | {
    type: TypeProperty;
    displayName?: string;
    group?: string;
    default?: unknown;
...
export declare type NodeOutput = TypeNames | {
    type: TypeProperty;
    displayName?: string;
    group?: string;
    /** Tooltip. */
...
export declare type NodeSignal = {
...
export declare type NodeMethod<TInstance> = {
    (this: TInstance & NodeInstance, ...args: any): unknown;
};
export declare type InspectInfoFunc = () => {
    type: "text" | "color";
    value: string;
}[] | string | undefined;
export declare type NodeDefinition<TInstance = {}> = {
    /**
     * Sets the name.
     *
     * IMPORTANT:
...
export declare type ReactNodeDefinition<TInstance = {}> = NodeDefinition<TInstance> & {
