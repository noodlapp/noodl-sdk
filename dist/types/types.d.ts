...
export declare type Type = ObjectType | ArrayType | StringType | StringListType | NumberType | BooleanType | SignalType | EnumType | ColorType | ImageType | IconType | FontType | TextStyleType | ComponentType | DimensionType | SourceType | ResizingType | VariableType | CurveType | QueryFilterType | QuerySortingType | PagesType | ProplistType;
/**
 * List of all the type names, including any (*) and custom types (string).
 */
export declare type TypeNames = Type["name"] | "*" | string;
export declare type TypeEditor = "javascript" | "graphql" | "css" | "html";
export declare type TypeWithEditor = Type & {
    codeeditor?: TypeEditor;
    allowEditOnly?: boolean;
};
export declare type TypeProperty = TypeNames | Type | TypeWithEditor;
export {};
