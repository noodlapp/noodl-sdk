...
export declare type InternalNodeInput = {
    type: Type | string;
...
export declare type InternalNodeOutput = {
    type: Type | string;
    displayName: string | undefined;
    group: string | undefined;
    getter: (() => unknown) | undefined;
};
declare type InternalReactNodeExtra = {
...
export declare type InternalNodeDefinition = InternalReactNodeExtra & {
    name: string;
...
export declare type NodeEditorContext = {
    variants: any;
...
export declare type NodeScope = {
     ...
     * @param extraProps
     */
    createNode(name: string, id: string | undefined, extraProps?: {
        [key: string]: any;
...
export declare type NodeRegister = {
